...
contract TokenRecipient {
     ...
     */
    function receiveApproval(address from, uint256 value, address token, bytes calldata extraData) public {
        ERC20 t = ERC20(token);
...
contract Exchange is ExchangeCore {
     ...
     */
    function guardedArrayReplace(bytes calldata array, bytes calldata desired, bytes calldata mask)
        public
        pure
...
contract AuthenticatedProxy is TokenRecipient, OwnedUpgradeabilityStorage {
     ...
     */
    function proxy(address dest, HowToCall howToCall, bytes calldata callData)
        public
        returns (bool result)
    {
